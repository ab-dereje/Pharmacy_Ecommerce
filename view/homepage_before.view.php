...
<head>
    ...
    <link rel="stylesheet" href="../Assets/css/home_before.css">
...
<body>
    <div class="header-content">
        ...
        <div class="nav-bar">
            ...
            <button class="create_acc"><a href="../view/index.php">Sign Up</a></button>
            <button class="log_acc"><a href="../view/login.view.php">Login</a></button>
            <!-- <div class="menu-icon">
